    ...
    return (
        <div className=''>
            ...
            <div className='flex flex-row lg:flex-row xl:flex-row md:flex-col sm:flex-col justify-center lg:h-[calc(100vh_-_180px)]  bg-[#FFFFFF] text-black'>
                <div className='lg:w-6/12 xl:w-6/12 flex pr-18 md:w-full sm:w-full'>
                    <div className='w-5/5'>
                        <img
                ...
                <div className='flex flex-col md:w-full sm:w-full justify-center lg:w-6/12 xl:w-6/12 text-left py-14 px-24'>
            ...
            <div className='flex flex-row lg:flex-row xl:flex-row md:flex-col sm:flex-col lg:h-[85vh] bg-green-50'>
                ...
                {/* <div className='w-6/12 flex pl-18 md:w-full sm:w-full lg:order-last sm:order-first md:order-first'> */}
