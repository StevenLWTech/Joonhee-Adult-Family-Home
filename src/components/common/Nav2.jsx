                        ...
                        <div className="relative flex h-20 md:h-32 lg:h-40 items-center justify-center border-b-8 border-[#6FB551]">
                            <div className='flex justify-center items-center space-x-4 border-r-2 border-[#6FB551] w-2/12 hidden lg:flex'>
                                ...
                                <span className='flex cursor-not-allowed'>
                                    <a href="https://instagram.com" className='hover:text-green-400 pr-4 pointer-events-none'>
                                        <svg
                                ...
                                <span className='flex cursor-not-allowed'>
                                    {/*Facebook*/}
                                    <a href="https://www.facebook.com/" className='hover:text-green-400 pr-4 pointer-events-none'>
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className="h-5 w-5"
                                            fill="currentColor"
                                ...
                                <span className='flex cursor-not-allowed'>
                                    ...
                                    {/*Twitter*/}
                                    <a href="https://twitter.com/home" className='hover:text-green-400 pointer-events-none'>
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className="h-5 w-5"
                                            fill="currentColor"
