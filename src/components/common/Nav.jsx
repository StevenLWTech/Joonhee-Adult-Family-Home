  ...
  return (
    <nav>
      ...
      <div className="flex justify-center .w-full bg-white text-[#303D46] h-40 border-b-8 border-[#6FB551]">
        ...
        <div className='flex items-center space-x-16 justify-center w-9/12'>
          <a href="/" className='pl-2 hover:text-green-400 text-xl '><a href="/">HOME</a></a>
          <a href="/about" className='hover:text-green-400 text-xl'>ABOUT US</a>
          <a href="/" className='px-10'>
            <div className='text-3xl '>'Joonhee</div>
            <div className='text-sm  '>SENIOR LIVING</div>
          </a>
          <a href="/" className='hover:text-green-400 text-xl'>OUR AFH</a>
          <a href="/" className='pr-2 hover:text-green-400 text-xl'>FAQS</a>
        </div>

        <a href="/" className='flex justify-center items-center w-2/12 bg-[#3B9592] text-xl text-white hover:text-[#303D46]'>
          Contact
        </a>
