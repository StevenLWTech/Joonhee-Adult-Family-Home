            ...
            <div className='flex flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row h-8/12 '>
                ...
                <div className='flex flex-col justify-center w-full sm:w-full md:w-full lg:w-1/3 xl:w-1/3 bg-[#FFFFF] text-[#485C69] text-left px-6 pr-12 md:pr-8 py-4'>
                    ...
                    <div className='flex flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-row text-md pb-4'>
                        <a href='/contact' className='px-4 text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl hover:text-black hover:underline flex flex-row'>
                        ...
                        <span className='flex cursor-not-allowed'>
                            ...
                            <a href='/' className='pl-4 text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl hover:text-black hover:underline flex flex-row pointer-events-none'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" />
                                </svg>
            ...
            <div className='flex flex-col justify-center h-5/12 bg-black text-white py-4 pt-8'>
                ...
                <div className="footer-nav flex flex-col text-center sm:text-left md:flex-row lg:flex-row xl:flex-row justify-center sm:py-4 md:py-4">
                    ...
                    <span className='cursor-not-allowed'>
                        <a href='/about' className='pr-12 pb-1 hover:text-green-400 pointer-events-none' >ABOUT US</a>
                    </span>
                    <span className='cursor-not-allowed'>
                        <a href='/' className='pr-12 pb-1 hover:text-green-400 pointer-events-none' >OUR AFH</a>
                    </span>
                    <span className='cursor-not-allowed'>
                        <a href='/' className='pr-12 pb-1 hover:text-green-400 pointer-events-none' >FAQS</a>
                    </span>
                ...
                <div className='social-media flex xl:flex-row justify-center py-6  md:py-4'>
                    ...
                    {/*Instagram*/}
                    <span className='cursor-not-allowed'>
                        <a href='/' className='pr-4 xl:pr-8 hover:text-green-400 pointer-events-none'>
                            <svg
                    ...
                    {/*Twitter*/}
                    <span className='cursor-not-allowed'>
                        <a href='/' className='hover:text-green-400 pointer-events-none'>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-5 w-5"
                                fill="currentColor"
